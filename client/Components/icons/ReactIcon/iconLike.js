...
export const IconLike = ({ width = '100%', height = '100%', ...props }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width={width} height={height}>
      ...
      <defs>
        <linearGradient id="a" x1="8" x2="8" y2="16" gradientUnits="userSpaceOnUse">
          <stop stopColor="#18afff" className="stopColor18AFFF svgShape"></stop>
          <stop offset="1" stopColor="#0062df" className="stopColor0062DF svgShape"></stop>
        </linearGradient>
      </defs>
    </svg>
  );
