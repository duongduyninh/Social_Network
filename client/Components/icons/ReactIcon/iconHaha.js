...
export const IconHaha = ({ width = '100%', height = '100%', ...props }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width={width} height={height}>
      <path fill="url(#haha_1)" d="M16 8A8 8 0 1 1-.001 8 8 8 0 0 1 16 8"></path>
      <path
        fill="url(#haha_2)"
      ...
      ></path>
      <defs>
        <linearGradient id="haha_1" x1="8" x2="8" y1="1.64" y2="16" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="haha_2" x1="8" x2="8" y1="7" y2="14" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="haha_3" x1="8.005" x2="8.005" y1="11" y2="13.457" gradientUnits="userSpaceOnUse">
          <stop stopColor="#fc607c" className="stopColorFC607C svgShape"></stop>
          <stop offset="1" stopColor="#d91f3a" className="stopColorD91F3A svgShape"></stop>
        </linearGradient>
      </defs>
    </svg>
  );
