...
export const IconWow = ({ width = '100%', height = '100%', ...props }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width={width} height={height}>
      <g clipPath="url(#wow_1)" fill="#000000" className="color000 svgShape">
        <path fill="url(#wow_2)" d="M16 8A8 8 0 1 1-.001 8 8 8 0 0 1 16 8"></path>
        <path
          fill="url(#wow_3)"
      ...
      <defs>
        <linearGradient id="wow_2" x1="8" x2="8" y1="1.64" y2="16" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="wow_3" x1="8" x2="8" y1="8" y2="14" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="wow_4" x1="8" x2="8" y1="4" y2="7" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="wow_7" x1="8" x2="8" y1="1.688" y2="2.888" gradientUnits="userSpaceOnUse">
        ...
        <clipPath id="wow_1">
          <path fill="#ffffff" d="M0 0h16v16H0z" className="colorfff svgShape"></path>
        </clipPath>
      </defs>
    </svg>
  );
